...
public class Context {
    ...
    *
    * It also reads feat.params which should be located at the root of acoustic model and sets corresponding parameters of
    ...
    *
    * Enables static grammar and disables probabilistic language model. JSGF and GrXML formats are supported.
    *
    ...
    *
    * Enables probabilistic language model and disables static grammar. Currently it supports ".lm", ".dmp" and ".bin" file formats.
    *
    ...
    *
    * Use this method to alter "value" property of a "property" tag inside a "component" tag of the XML configuration.
    *
    ...
    *
    * Use this method to alter "value" property of a "property" tag whose parent is the root tag "config" of the XML configuration.
    *
    * @param name property name
    * @param value property value
