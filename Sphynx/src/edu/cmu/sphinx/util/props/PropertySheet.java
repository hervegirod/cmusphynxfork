...
import edu.cmu.sphinx.util.LoggerConfig;
...
public class PropertySheet implements Cloneable {
   ...
   /**
    * Gets a component associated with the given parameter name. First search the component in property table, then try to get component by name from
    * the manager, then creates component with default properties.
    *
    * @param name the parameter name
    * @return the component associated with the name
    * @throws edu.cmu.sphinx.util.props.PropertyException if the component does not exist or is of the wrong type.
    */
   ...
   /**
    * Parses the string with multiple URL's separated by ;. Return the list of resources to load
    *
    * @param name list with URL's
   ...
   /**
    * @return the owner of this property sheet. In most cases this will be the configurable instance which was instrumented by this property sheet.
    */
   ...
   /**
    * @return the set of all component properties which were tagged as mandatory but which are not set (or no default value is given).
    */
    ...
    *
    * @param name the simple property name
    * @param valueNames the list of names of the configurables within the configuration manager (required for serialization only)
    * @param value the value for the property
    */
   ...
   /**
    * Returns a logger to use for this configurable component. The logger can be configured with the property: 'logLevel' - The default logLevel value
    * is defined (within the xml configuration file by the global property 'defaultLogLevel' (which defaults to WARNING).
    * <p>
   ...
   /**
    * Returns true if two property sheet define the same object in terms of configuration. The owner (and the parent configuration manager) are not
